...
SYSTEM_PROMPT = (
    ...
    "PENTING: Input kamu berasal dari speech-to-text yang KADANG salah dengar "
    "(misal: 'kontakan' jadi 'kontrakan'). Kalau ada kata yang tidak nyambung "
    "dengan topik pembicaraan, tafsirkan kata yang paling mungkin sesuai konteks "
    "obrolan, dan balas sesuai maksud yang masuk akal itu. "
